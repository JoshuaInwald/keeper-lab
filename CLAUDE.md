...
- `docs/`: METHODS (how), FINDINGS (results, numbered #1-#55, cited from code comments), ROADMAP (next), WORKFLOWS (recipes), SESSION-LOG (history), constitution.txt (league rules).
