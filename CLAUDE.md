...
- `docs/`: METHODS (how), FINDINGS (results, numbered #1-#76, cited from code comments), ROADMAP (next), WORKFLOWS (recipes), SESSION-LOG (history), ASSESSMENT-BRIEF (a closed phase, kept as a stub), constitution.txt (league rules).
