...
| `fg_zips_dc_2027_*`, `fg_zips_dc_2028_*` | FanGraphs ZiPS Depth Charts, full-year | FanGraphs reruns these a handful of times a year; refresh before any keeper decision or the auction itself. Winter calendar (docs/MODEL-REVIEW.md section 5): Steamer 2027 ~Nov is the FIRST 2026-aware system, fresh ZiPS lands Nov-Jan, ATC ~Feb; any FanGraphs export with standard column names drops in via `config.PROJ_2027_*`, a filename switch. FanGraphs CSV export is members-only | manual export |
